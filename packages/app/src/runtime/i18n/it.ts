export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Shuvcode.",
  ...
  "dialog.server.description": "Cambia il server Shuvcode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Shuvcode…",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Shuvcode in {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Shuvcode…",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Shuvcode in {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Shuvcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Shuvcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Shuvcode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Shuvcode.",
  ...
  "toast.update.description": "Una nuova versione di Shuvcode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Shuvcode",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Shuvcode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Shuvcode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Shuvcode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Shuvcode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Shuvcode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Shuvcode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Shuvcode",
  ...
  "settings.updates.toast.latest.title": "Shuvcode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Shuvcode.",
  ...
  "desktop.menu.documentation": "Documentazione di Shuvcode",
  ...
  "desktop.menu.ariaLabel": "Menu Shuvcode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Shuvcode",
  "desktop.recovery.terminated": "La finestra di Shuvcode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Shuvcode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Shuvcode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Shuvcode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
