export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Shuvcode",
  "desktop.recovery.terminated": "توقفت نافذة Shuvcode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Shuvcode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Shuvcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Shuvcode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Shuvcode.",
  ...
  "dialog.server.description": "تبديل خادم Shuvcode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Shuvcode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Shuvcode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Shuvcode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Shuvcode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Shuvcode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Shuvcode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Shuvcode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Shuvcode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Shuvcode.",
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Shuvcode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Shuvcode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Shuvcode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Shuvcode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Shuvcode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Shuvcode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Shuvcode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Shuvcode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Shuvcode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Shuvcode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Shuvcode.",
