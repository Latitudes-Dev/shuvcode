export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Shuvcode.",
  ...
  "dialog.server.description": "Skift hvilken Shuvcode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Shuvcode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Shuvcode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Shuvcode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Shuvcode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Shuvcode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Shuvcode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Shuvcode igen.",
  ...
  "toast.update.description": "En ny version af Shuvcode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Shuvcode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Shuvcode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Shuvcode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Shuvcode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Shuvcode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Shuvcode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Shuvcodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Shuvcode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Shuvcode.",
  ...
  "desktop.recovery.loadFailed": "Shuvcode kunne ikke indlæses",
  "desktop.recovery.terminated": "Shuvcode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Shuvcode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Shuvcode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
