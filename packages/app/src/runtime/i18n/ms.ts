export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Shuvcode",
  ...
  "desktop.recovery.loadFailed": "Shuvcode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Shuvcode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Shuvcode tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Shuvcode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Shuvcode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Shuvcode.",
  ...
  "dialog.server.description": "Tukar pelayan Shuvcode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Shuvcode…",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Shuvcode dalam {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Shuvcode…",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Shuvcode dalam {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Shuvcode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Shuvcode dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Shuvcode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Shuvcode.",
  ...
  "toast.update.description": "Versi baharu Shuvcode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Shuvcode",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Shuvcode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Shuvcode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Shuvcode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Shuvcode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Shuvcode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Shuvcode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Shuvcode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Shuvcode.",
