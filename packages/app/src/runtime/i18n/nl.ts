export const dict = {
  ...
  "desktop.menu.documentation": "Shuvcode-documentatie",
  ...
  "desktop.recovery.loadFailed": "Shuvcode kan niet worden geladen",
  "desktop.recovery.terminated": "Het Shuvcode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Shuvcode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Shuvcode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Shuvcode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Shuvcode te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Shuvcode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Shuvcode te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Shuvcode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Shuvcode controleren…",
  "wsl.onboarding.checkingOpencodeIn": "Shuvcode controleren in {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Shuvcode bijwerken…",
  "wsl.onboarding.updatingOpencodeIn": "Shuvcode bijwerken in {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Werk Shuvcode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Shuvcode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Shuvcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Shuvcode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Shuvcode opnieuw.",
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Shuvcode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Shuvcode-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Shuvcode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Shuvcode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Shuvcode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Shuvcode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Shuvcode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Shuvcode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Shuvcode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Shuvcode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Shuvcode.",
