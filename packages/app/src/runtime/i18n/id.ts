export const dict = {
  ...
  "desktop.recovery.loadFailed": "Shuvcode gagal dimuat",
  "desktop.recovery.terminated": "Jendela Shuvcode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Shuvcode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Shuvcode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Shuvcode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Shuvcode.",
  ...
  "dialog.server.description": "Ganti server Shuvcode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Shuvcode…",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Shuvcode di {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Memperbarui Shuvcode…",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Shuvcode di {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Shuvcode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Shuvcode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Shuvcode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Shuvcode.",
  ...
  "toast.update.description": "Versi baru Shuvcode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Shuvcode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Shuvcode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Shuvcode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Shuvcode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Shuvcode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Shuvcode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Shuvcode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Shuvcode.",
