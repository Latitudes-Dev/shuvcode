export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Shuvcode",
  ...
  "desktop.menu.ariaLabel": "Shuvcode meni",
  ...
  "desktop.recovery.loadFailed": "Shuvcode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Shuvcode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Shuvcode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Shuvcode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Shuvcode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Shuvcode-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Shuvcode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Shuvcode-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Shuvcode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Shuvcode…",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Shuvcode u distribuciji {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Shuvcode…",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Shuvcode u distribuciji {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Shuvcode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Shuvcode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Shuvcode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Shuvcode.",
  ...
  "toast.update.description": "Nova verzija Shuvcode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Shuvcode timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Shuvcode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Shuvcode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Shuvcode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Shuvcode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Shuvcode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Shuvcode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Shuvcode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Shuvcode-a.",
