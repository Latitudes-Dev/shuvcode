...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Shuvcode įkelti nepavyko",
  "Shuvcode langas netikėtai užsidarė",
  "Shuvcode neatsako",
  ...
  "Shuvcode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Shuvcode neįdiegtas distributyve {{distro}}",
  "Shuvcode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Shuvcode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Shuvcode.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Shuvcode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Shuvcode…",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Shuvcode {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Shuvcode…",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Shuvcode {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Shuvcode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Shuvcode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Shuvcode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Shuvcode.",
  ...
  "toast.update.description": "Dabar galima įdiegti naują Shuvcode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Shuvcode komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Shuvcode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Shuvcode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Shuvcode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Shuvcode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Shuvcode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Shuvcode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Shuvcode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Shuvcode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Shuvcode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Shuvcode versiją.",
