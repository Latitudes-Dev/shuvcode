export const dict = {
  ...
  "desktop.recovery.loadFailed": "Shuvcodeを読み込めませんでした",
  "desktop.recovery.terminated": "Shuvcodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Shuvcodeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcodeのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはShuvcodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Shuvcodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Shuvcodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Shuvcodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してShuvcodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Shuvcodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するShuvcodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Shuvcodeを確認中…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のShuvcodeを確認中…",
  "wsl.onboarding.updatingOpencode": "Shuvcodeを更新中…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のShuvcodeを更新中…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のShuvcodeを更新してください。",
  "wsl.onboarding.updateOpencode": "Shuvcodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のShuvcodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "Shuvcodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にShuvcodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "Shuvcodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ShuvcodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Shuvcodeをもう一度開いてください。",
  ...
  "toast.update.description": "Shuvcodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをShuvcodeチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ShuvcodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Shuvcodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でShuvcodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Shuvcodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのShuvcodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Shuvcodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Shuvcodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Shuvcode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Shuvcode は最新バージョンです。",
