...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Shuvcode se nije uspio učitati",
  "Prozor aplikacije Shuvcode neočekivano je zatvoren",
  "Shuvcode ne reagira",
  ...
  "Instalacija aplikacije Shuvcode nije uspjela",
  ...
  "Shuvcode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Shuvcode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Shuvcode.",
  ...
  "dialog.server.description": "Promijenite na koji se Shuvcode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Shuvcode u {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Shuvcode…",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Shuvcode u {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Shuvcode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Shuvcode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Shuvcode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Shuvcode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Shuvcode.",
  ...
  "toast.update.description": "Nova verzija Shuvcode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Shuvcode timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Shuvcode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Shuvcode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Shuvcode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Shuvcode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Shuvcode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Shuvcode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Shuvcode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Shuvcode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Shuvcode.",
