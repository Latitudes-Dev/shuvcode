...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Shuvcode zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Shuvcode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Shuvcode zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Shuvcode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Shuvcode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Shuvcode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Shuvcode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Shuvcode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Shuvcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Shuvcode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Shuvcode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Shuvcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Shuvcode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Shuvcode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Shuvcode erneut.",
  ...
  "toast.update.description": "Eine neue Version von Shuvcode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Shuvcode-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Shuvcode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Shuvcode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Shuvcode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Shuvcode Desktop",
  ...
  "settings.desktop.wsl.description": "Shuvcode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Shuvcode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Shuvcode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Shuvcode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Shuvcode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Shuvcode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Shuvcode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Shuvcode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Shuvcode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Shuvcode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Shuvcode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcode-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Shuvcode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
