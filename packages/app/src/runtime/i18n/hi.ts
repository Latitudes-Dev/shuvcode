export const dict = {
  ...
  "desktop.menu.documentation": "Shuvcode दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Shuvcode मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Shuvcode लोड नहीं हो सका",
  "desktop.recovery.terminated": "Shuvcode विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Shuvcode प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcode इंस्टॉल नहीं हो सका",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में Shuvcode इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "Shuvcode अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.model.unpaid.freeModels.title": "Shuvcode द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Shuvcode में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Shuvcode में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Shuvcode में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Shuvcode सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "Shuvcode की जाँच हो रही है…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में Shuvcode की जाँच हो रही है…",
  "wsl.onboarding.updatingOpencode": "Shuvcode अपडेट हो रहा है…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में Shuvcode अपडेट हो रहा है…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में Shuvcode को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "Shuvcode को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "Shuvcode तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में Shuvcode स्थापित करें।",
  "wsl.onboarding.installOpencode": "Shuvcode स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Shuvcode द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Shuvcode को फिर से खोलें।",
  ...
  "toast.update.description": "Shuvcode ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Shuvcode टीम को करें",
  ...
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Shuvcode अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Shuvcode सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Shuvcode के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Shuvcode आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Shuvcode सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Shuvcode की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Shuvcode लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Shuvcode का नवीनतम संस्करण चला रहे हैं।",
