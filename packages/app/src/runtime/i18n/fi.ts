export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Shuvcoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Shuvcodessa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Shuvcodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Shuvcodessa.",
  ...
  "dialog.server.description": "Vaihda Shuvcode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Shuvcodea…",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Shuvcodea kohteessa {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Päivitetään Shuvcodea…",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Shuvcodea kohteessa {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Shuvcode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Shuvcode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Shuvcode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Shuvcode uudelleen.",
  ...
  "toast.update.description": "Shuvcoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Shuvcode-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Shuvcode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Shuvcode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Shuvcoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Shuvcode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Shuvcode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Shuvcoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Shuvcode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Shuvcoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "Shuvcode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Shuvcode-valikko",
  ...
  "desktop.recovery.loadFailed": "Shuvcoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "Shuvcode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Shuvcode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shuvcoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
