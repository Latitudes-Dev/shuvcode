export const dict = {
  ...
  "desktop.recovery.loadFailed": "Shuvcode yüklənə bilmədi",
  "desktop.recovery.terminated": "Shuvcode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Shuvcode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcode quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Shuvcode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Shuvcode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Shuvcode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Shuvcode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Shuvcode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Shuvcode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Shuvcode yoxlanılır…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Shuvcode yoxlanılır…",
  "wsl.onboarding.updatingOpencode": "Shuvcode yenilənir…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Shuvcode yenilənir…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Shuvcode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Shuvcode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Shuvcode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Shuvcode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Shuvcode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Shuvcode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Shuvcode-u yenidən açın.",
  ...
  "toast.update.description": "Shuvcode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Shuvcode komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Shuvcode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Shuvcode serverini işlət.",
  ...
  "settings.general.row.language.description": "Shuvcode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Shuvcode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Shuvcode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Shuvcode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Shuvcode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Shuvcode-un ən son versiyasından istifadə edirsiniz.",
