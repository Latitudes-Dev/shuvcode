export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Shuvcode",
  ...
  "desktop.menu.ariaLabel": "Menu do Shuvcode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Shuvcode",
  "desktop.recovery.terminated": "A janela do Shuvcode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Shuvcode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Shuvcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Shuvcode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Shuvcode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Shuvcode.",
  ...
  "dialog.server.description": "Trocar para qual servidor Shuvcode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Shuvcode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Shuvcode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Shuvcode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Shuvcode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Shuvcode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "O Shuvcode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Shuvcode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Shuvcode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Shuvcode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Shuvcode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Shuvcode novamente.",
  ...
  "toast.update.description": "Uma nova versão do Shuvcode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Shuvcode",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Shuvcode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Shuvcode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Shuvcode",
  ...
  "settings.general.row.appearance.description": "Personalize como o Shuvcode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Shuvcode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Shuvcode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Shuvcode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Shuvcode.",
