export const dict = {
  ...
  "desktop.menu.documentation": "Shuvcode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Shuvcode menyusi",
  ...
  "desktop.recovery.loadFailed": "Shuvcode yuklanmadi",
  "desktop.recovery.terminated": "Shuvcode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Shuvcode javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcode oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Shuvcode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Shuvcode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Shuvcode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Shuvcode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Shuvcode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Shuvcode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Shuvcode tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Shuvcode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Shuvcode yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Shuvcode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Shuvcode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Shuvcode-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Shuvcode tayyor.",
  "wsl.onboarding.installOpencodeIn": "Shuvcode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Shuvcode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Shuvcode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Shuvcode-ni qayta oching.",
  ...
  "toast.update.description": "Shuvcode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Shuvcode jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Shuvcode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Shuvcode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Shuvcode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Shuvcode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Shuvcode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Shuvcode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Shuvcode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Shuvcode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Shuvcode oxirgi versiyasini ishga tushiryapsiz.",
