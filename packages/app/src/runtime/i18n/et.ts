export const dict = {
  ...
  "desktop.recovery.loadFailed": "Shuvcode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Shuvcode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Shuvcode ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcode installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shuvcode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Shuvcode'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Shuvcode.",
  ...
  "dialog.server.description": "Lülitage, millise Shuvcode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Shuvcode kontrollimine…",
  "wsl.onboarding.checkingOpencodeIn": "Shuvcode kontrollimine asukohas {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Shuvcode värskendamine…",
  "wsl.onboarding.updatingOpencodeIn": "Shuvcode värskendamine asukohas {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Shuvcode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Shuvcode asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Shuvcode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Shuvcode.",
  ...
  "toast.update.description": "Rakenduse Shuvcode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Shuvcode meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Shuvcode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Shuvcode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Shuvcode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Shuvcode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Shuvcode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Shuvcode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Shuvcode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Shuvcode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Shuvcode uusimat versiooni.",
