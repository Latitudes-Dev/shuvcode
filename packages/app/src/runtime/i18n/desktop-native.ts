...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Shuvcode failed to load",
  "desktop.recovery.terminated": "Shuvcode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Shuvcode is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcode installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shuvcode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
