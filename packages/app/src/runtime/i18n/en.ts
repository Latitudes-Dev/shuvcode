...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Shuvcode.",
  ...
  "dialog.server.description": "Switch which Shuvcode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Shuvcode…",
  "wsl.onboarding.checkingOpencodeIn": "Checking Shuvcode in {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Updating Shuvcode…",
  "wsl.onboarding.updatingOpencodeIn": "Updating Shuvcode in {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Update Shuvcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Shuvcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Shuvcode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Shuvcode.",
  ...
  "server.row.incompatible":
    "This server is running Shuvcode {{version}}, which isn't compatible with this app. Upgrade it to Shuvcode V2 to continue.",
  ...
  "toast.update.description": "A new version of Shuvcode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Shuvcode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Shuvcode does not support MCP authentication yet.',
  ...
  "session.error.incompatible.description":
    "{{server}} is running Shuvcode {{version}}, which isn't compatible with this app. Upgrade the server to Shuvcode V2 to continue.",
  ...
  "sidebar.gettingStarted.line1": "Shuvcode includes free models so you can start immediately.",
  ...
  "settings.about.description": "Shuvcode, the open source coding agent",
  "settings.about.trademark": "Shuvcode is a registered trademark of Anomaly Innovations, Inc.",
  ...
  "settings.desktop.wsl.description": "Run the Shuvcode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Shuvcode",
  ...
  "settings.general.row.appearance.description": "Customise how Shuvcode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Shuvcode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Shuvcode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Shuvcode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Shuvcode.",
