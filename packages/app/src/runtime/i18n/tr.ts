...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Shuvcode yüklenemedi",
  "desktop.recovery.terminated": "Shuvcode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Shuvcode yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcode kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Shuvcode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Shuvcode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Shuvcode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Shuvcode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Shuvcode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Shuvcode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Shuvcode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Shuvcode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Shuvcode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Shuvcode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Shuvcode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Shuvcode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Shuvcode hazır.",
  "wsl.onboarding.opencodeReady": "Shuvcode hazır.",
  "wsl.onboarding.installOpencodeIn": "Shuvcode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Shuvcode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Shuvcode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Shuvcode'u tekrar açın.",
  ...
  "toast.update.description": "Shuvcode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Shuvcode ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Shuvcode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Shuvcode Masaüstü",
  ...
  "settings.desktop.wsl.description": "Shuvcode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Shuvcode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Shuvcode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Shuvcode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Shuvcode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Shuvcode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Shuvcode'un en son sürümünü kullanıyorsunuz.",
