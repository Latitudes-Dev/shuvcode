export const dict = {
  ...
  "desktop.menu.documentation": "Shuvcode دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Shuvcode مینو",
  ...
  "desktop.recovery.loadFailed": "Shuvcode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Shuvcode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Shuvcode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcode کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں Shuvcode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Shuvcode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "Shuvcode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Shuvcode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Shuvcode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Shuvcode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Shuvcode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Shuvcode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Shuvcode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Shuvcode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Shuvcode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Shuvcode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Shuvcode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "Shuvcode تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Shuvcode انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Shuvcode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Shuvcode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Shuvcode کو دوبارہ کھولیں۔",
  ...
  "toast.update.description": "Shuvcode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Shuvcode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Shuvcode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Shuvcode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Shuvcode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Shuvcode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Shuvcode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Shuvcode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Shuvcode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Shuvcode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Shuvcode کا تازہ ترین ورژن چلا رہے ہیں۔",
