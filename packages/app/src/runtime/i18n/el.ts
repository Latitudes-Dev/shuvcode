export const dict = {
  ...
  "desktop.menu.documentation": "Shuvcode Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Shuvcode μενού",
  ...
  "desktop.recovery.loadFailed": "Shuvcode απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Shuvcode το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Shuvcode δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcode η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shuvcode η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Shuvcode.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shuvcode Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Shuvcode.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Shuvcode συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.step.opencode": "Shuvcode",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Shuvcode...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Shuvcode σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Shuvcode...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Shuvcode σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Shuvcode σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Shuvcode στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Shuvcode να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Shuvcode.",
  ...
  "toast.update.description": "Μια νέα έκδοση του Shuvcode ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Shuvcode",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Shuvcode δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Shuvcode Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Shuvcode μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Shuvcode",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Shuvcode στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Shuvcode ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Shuvcode.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Shuvcode",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Shuvcode.",
