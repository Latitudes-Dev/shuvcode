export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Shuvcode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Shuvcode",
  "desktop.recovery.terminated": "Okno Shuvcode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Shuvcode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Shuvcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Shuvcode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Shuvcode.",
  ...
  "dialog.server.description": "Przełącz serwer Shuvcode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Shuvcode…",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Shuvcode w dystrybucji {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Shuvcode…",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Shuvcode w dystrybucji {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Shuvcode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Shuvcode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Shuvcode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Shuvcode.",
  ...
  "toast.update.description": "Nowa wersja Shuvcode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Shuvcode",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Shuvcode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Shuvcode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Shuvcode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Shuvcode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Shuvcode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Shuvcode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Shuvcode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Shuvcode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Shuvcode.",
