export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Shuvcode",
  ...
  "desktop.menu.ariaLabel": "Menú de Shuvcode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Shuvcode",
  "desktop.recovery.terminated": "La ventana de Shuvcode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Shuvcode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Shuvcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Shuvcode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Shuvcode.",
  ...
  "dialog.server.description": "Cambiar el servidor de Shuvcode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Shuvcode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Shuvcode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Shuvcode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Shuvcode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Shuvcode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Shuvcode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Shuvcode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Shuvcode.",
  ...
  "toast.update.description": "Una nueva versión de Shuvcode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Shuvcode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Shuvcode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Shuvcode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Shuvcode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Shuvcode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Shuvcode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Shuvcode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Shuvcode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Shuvcode.",
