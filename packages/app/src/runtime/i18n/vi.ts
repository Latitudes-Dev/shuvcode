export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Shuvcode",
  ...
  "desktop.recovery.loadFailed": "Không tải được Shuvcode",
  "desktop.recovery.terminated": "Cửa sổ Shuvcode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Shuvcode không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Shuvcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Shuvcode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Shuvcode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Shuvcode.",
  ...
  "dialog.server.description": "Chuyển máy chủ Shuvcode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Shuvcode…",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Shuvcode trong {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Shuvcode…",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Shuvcode trong {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Shuvcode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Shuvcode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Shuvcode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Shuvcode.",
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Shuvcode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Shuvcode",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Shuvcode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Shuvcode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Shuvcode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Shuvcode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Shuvcode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Shuvcode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Shuvcode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Shuvcode.",
