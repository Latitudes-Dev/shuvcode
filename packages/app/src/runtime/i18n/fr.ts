export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Shuvcode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Shuvcode",
  "desktop.recovery.terminated": "La fenêtre Shuvcode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Shuvcode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Shuvcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Shuvcode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Shuvcode.",
  ...
  "dialog.server.description": "Changez le serveur Shuvcode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Shuvcode…",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Shuvcode dans {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Shuvcode…",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Shuvcode dans {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Shuvcode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Shuvcode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Shuvcode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Shuvcode.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Shuvcode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Shuvcode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Shuvcode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Shuvcode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Shuvcode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Shuvcode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Shuvcode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Shuvcode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Shuvcode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Shuvcode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Shuvcode.",
