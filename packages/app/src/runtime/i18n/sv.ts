export const dict = {
  ...
  "desktop.recovery.loadFailed": "Shuvcode kunde inte läsas in",
  "desktop.recovery.terminated": "Shuvcode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Shuvcode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Shuvcode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shuvcode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Shuvcode.",
  ...
  "dialog.server.description": "Växla vilken Shuvcode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Shuvcode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Shuvcode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Shuvcode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Shuvcode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Shuvcode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Shuvcode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Shuvcode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Shuvcode igen.",
  ...
  "toast.update.description": "En ny version av Shuvcode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Shuvcode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Shuvcode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Shuvcode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Shuvcode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Shuvcode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Shuvcode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Shuvcodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Shuvcode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Shuvcode.",
