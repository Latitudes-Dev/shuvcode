...
export const dict = {
  ...
  "desktop.menu.documentation": "Shuvcode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Shuvcode-meny",
  ...
  "desktop.recovery.loadFailed": "Shuvcode kunne ikke lastes inn",
  "desktop.recovery.terminated": "Shuvcode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Shuvcode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Shuvcode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Shuvcode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Shuvcode.",
  ...
  "dialog.server.description": "Bytt hvilken Shuvcode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Shuvcode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Shuvcode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Shuvcode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Shuvcode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Shuvcode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Shuvcode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Shuvcode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Shuvcode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Shuvcode starter",
  ...
  "settings.updates.toast.latest.title": "Shuvcode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Shuvcode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Shuvcode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Shuvcode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Shuvcode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Shuvcode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Shuvcode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Shuvcode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Shuvcode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Shuvcode på nytt.",
