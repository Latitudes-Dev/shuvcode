export const dict = {
  ...
  "desktop.menu.documentation": "Shuvcode დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "Shuvcode მენიუ",
  ...
  "desktop.recovery.loadFailed": "Shuvcode ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "Shuvcode ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "Shuvcode არ პასუხობს",
  ...
  "desktop.wsl.error.installOpencode": "Shuvcode ინსტალაცია ვერ მოხერხდა",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shuvcode განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Shuvcode-ში.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები Shuvcode-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Shuvcode-ში.",
  ...
  "dialog.server.description": "გადართეთ რომელ Shuvcode სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია Shuvcode…",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია Shuvcode-ში {{distro}}…",
  "wsl.onboarding.updatingOpencode": "განახლება Shuvcode…",
  "wsl.onboarding.updatingOpencodeIn": "Shuvcode განახლება ხდება {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "განახლება Shuvcode {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode მზად არის {{distro}}-ში.",
  "wsl.onboarding.opencodeReady": "Shuvcode მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ Shuvcode {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ Shuvcode შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით Shuvcode.",
  ...
  "toast.update.description": "Shuvcode-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა Shuvcode გუნდს",
  ...
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, Shuvcode ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "Shuvcode სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით Shuvcode სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა Shuvcode",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება Shuvcode თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა Shuvcode სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის Shuvcode თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც Shuvcode გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ Shuvcode-ის უახლეს ვერსიას.",
