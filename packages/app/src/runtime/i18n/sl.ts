export const dict = {
  ...
  "desktop.menu.documentation": "Shuvcode Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Shuvcode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Shuvcode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Shuvcode se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Shuvcode ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shuvcode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Shuvcode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Shuvcode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Shuvcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Shuvcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Shuvcode.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Shuvcode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Shuvcode …",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Shuvcode v {{distro}} …",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Shuvcode …",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Shuvcode v {{distro}} …",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Shuvcode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Shuvcode",
  "wsl.onboarding.opencodeReadyIn": "Shuvcode je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shuvcode je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Shuvcode v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Shuvcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shuvcode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Shuvcode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Shuvcode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Shuvcode.",
  ...
  "toast.update.description": "Nova različica Shuvcode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Shuvcode",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Shuvcode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shuvcode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Shuvcode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Shuvcode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Shuvcode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Shuvcode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Shuvcode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Shuvcode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Shuvcode.",
