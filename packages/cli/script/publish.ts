...
import { preflightForkPublish, requireForkRepository, type ForkDistribution } from "./publish-ownership"
...
const repository = requireForkRepository(process.env.GITHUB_REPOSITORY ?? process.env.GH_REPO)
