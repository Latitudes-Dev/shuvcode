...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent shuvcode from reading sensitive files",
  "Use {highlight}shuvcode run{/highlight} for non-interactive scripting",
  "Use {highlight}shuvcode --continue{/highlight} to resume the last session",
  "Use {highlight}shuvcode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}shuvcode serve{/highlight} for headless API access to shuvcode",
  "Use {highlight}shuvcode run --attach{/highlight} to connect to a running server",
  "Run {highlight}shuvcode upgrade{/highlight} to update to the latest version",
  "Run {highlight}shuvcode auth list{/highlight} to see all configured providers",
  "Run {highlight}shuvcode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}shuvcode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}shuvcode debug config{/highlight} to troubleshoot configuration",
