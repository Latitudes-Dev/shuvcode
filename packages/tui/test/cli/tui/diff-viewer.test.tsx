...
async function renderDiffViewer(
  ...
  const stored: { info: Info } = {
    info: {
      ...
      // Color assertions below were authored against upstream's default theme; pin it so the
      // fork's Night Owl default does not change the expected menu/header backgrounds.
      theme: { name: "opencode" },
    },
  }
  const writes: Info[] = []
