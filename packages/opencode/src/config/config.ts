...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      session_search: z.string().optional().default("ctrl+f").describe("Search in session messages"),
  ...
  export const Ide = z
    .object({
      lockfile_dir: z.string().optional().describe("Directory to scan for IDE lockfiles"),
      auth_header_name: z.string().optional().describe("HTTP header name for IDE authentication"),
    })
    .strict()
    .meta({
      ref: "IdeConfig",
  ...
  export const Info = z
    .object({
      ...
      ide: Ide.optional().describe("IDE integration configuration for lockfile discovery and authentication"),
      command: z
