...
export function resolveTheme(theme: ThemeJson, mode: "dark" | "light", transparent: boolean) {
...
export function normalizeBackgrounds(resolved: Partial<ThemeColors>, transparent: boolean, mode: "dark" | "light") {
  if (transparent) {
