...
- `density` - Control the vertical density of the TUI layout.
  - `auto` (default): Automatically switches to compact mode when terminal height is small.
  - `comfortable`: Always use standard spacing.
  - `compact`: Always use reduced vertical whitespace.
