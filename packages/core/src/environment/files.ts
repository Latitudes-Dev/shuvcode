...
export interface FilesImpl {
  ...
  /** Resolves existing symlinks while retaining any missing suffix below the nearest existing ancestor. */
  readonly realpath: (path: string) => Effect.Effect<string, Failed>
