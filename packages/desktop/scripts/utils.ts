...
export const SIDECAR_BINARIES: Array<{ rustTarget: string; ocBinary: string; assetExt: string }> = [
  ...
  },
  {
    ...
    ocBinary: "shuvcode-darwin-x64-baseline",
    assetExt: "zip",
  },
  {
    rustTarget: "x86_64-pc-windows-msvc",
    ocBinary: "shuvcode-windows-x64-baseline",
    assetExt: "zip",
  },
  {
    rustTarget: "x86_64-unknown-linux-gnu",
    ocBinary: "shuvcode-linux-x64-baseline",
    assetExt: "tar.gz",
  },
  {
    rustTarget: "aarch64-unknown-linux-gnu",
    ocBinary: "shuvcode-linux-arm64",
    assetExt: "tar.gz",
  },
]
...
export async function copyBinaryToSidecarFolder(source: string, target = RUST_TARGET) {
  ...
  const dest = windowsify(`src-tauri/sidecars/shuvcode-cli-${target}`)
