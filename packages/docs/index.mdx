...
<Warning>
  These docs are for Shuvcode's OpenCode V2 line. It is still changing: we may wipe your data, things may break, and
  APIs, configuration, and plugin APIs may change.
</Warning>
...
<Note>The binary is called `shuvcode`.</Note>
...
<Tip>Give Shuvcode plenty of context and examples.</Tip>
...
Make Shuvcode your own by [picking a theme](https://opencode.ai/docs/themes), [customizing
