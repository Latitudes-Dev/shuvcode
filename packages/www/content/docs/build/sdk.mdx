---
title: "SDK"
description: "Embed Shuvcode directly in your application."
---

We're working on a general-purpose SDK for embedding Shuvcode directly inside
...
Its current documentation is below. For other applications, run Shuvcode as a
server and use the [TypeScript client](/build/client) in the meantime.

## Effect

`@opencode-ai/sdk-next` hosts Shuvcode in-process. Unlike the
...
<Callout type="warning">
  The V2 SDK is beta and currently private to the Shuvcode workspace. It is not published for external installation yet,
