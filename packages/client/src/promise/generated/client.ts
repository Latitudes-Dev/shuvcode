import type {
  ...
  HealthStopOutput,
  ServerGetOutput,
  PairingInvitationCreateOutput,
  PairingRedeemInput,
  PairingRedeemOutput,
  PairingDeviceListOutput,
  PairingDeviceRevokeInput,
  PairingDeviceRevokeOutput,
  LocationGetInput,
  LocationGetOutput,
  AgentListInput,
  AgentListOutput,
    ...
    health: {
      get: (requestOptions?: RequestOptions) =>
        request<HealthGetOutput>(
          { method: "GET", path: `/api/health`, successStatus: 200, declaredStatuses: [401, 403, 400], empty: false },
          requestOptions,
        ),
    ...
    server: {
      get: (requestOptions?: RequestOptions) =>
        request<ServerGetOutput>(
          { method: "GET", path: `/api/server`, successStatus: 200, declaredStatuses: [401, 403, 400], empty: false },
          requestOptions,
        ),
    },
    pairing: {
      invitation: {
        create: (requestOptions?: RequestOptions) =>
          request<PairingInvitationCreateOutput>(
            {
              method: "POST",
              path: `/api/pairing/invitation`,
              successStatus: 200,
              declaredStatuses: [401, 403, 503, 400],
              empty: false,
            },
            requestOptions,
          ),
      },
      redeem: (input: PairingRedeemInput, requestOptions?: RequestOptions) =>
        request<PairingRedeemOutput>(
          {
            method: "POST",
            ...
            successStatus: 200,
            declaredStatuses: [400, 409, 410, 401, 403],
            empty: false,
          },
          requestOptions,
        ),
      device: {
        list: (requestOptions?: RequestOptions) =>
          request<PairingDeviceListOutput>(
            {
              method: "GET",
              path: `/api/pairing/device`,
              successStatus: 200,
              declaredStatuses: [401, 403, 400],
              empty: false,
            },
        ...
        revoke: (input: PairingDeviceRevokeInput, requestOptions?: RequestOptions) =>
          request<PairingDeviceRevokeOutput>(
            {
              method: "DELETE",
              path: `/api/pairing/device/${encodeURIComponent(input.deviceID)}`,
              successStatus: 204,
              declaredStatuses: [401, 403, 404, 400],
              empty: true,
            },
            requestOptions,
          ),
        ...
        request<{ readonly data: SessionGetOutput }>(
          {
            ...
            successStatus: 200,
            declaredStatuses: [404, 400, 401, 403],
            empty: false,
          },
          requestOptions,
        ).then((value) => value.data),
        ...
        request<{ readonly data: SessionPromptOutput }>(
          {
            ...
            successStatus: 200,
            declaredStatuses: [409, 400, 404, 401, 403],
            empty: false,
          },
          requestOptions,
        ).then((value) => value.data),
        ...
        request<{ readonly data: SessionCommandOutput }>(
          {
            ...
            successStatus: 200,
            declaredStatuses: [409, 400, 404, 500, 401, 403],
            empty: false,
          },
          requestOptions,
        ).then((value) => value.data),
        ...
        request<{ readonly data: SessionSyntheticOutput }>(
          {
            ...
            successStatus: 200,
            declaredStatuses: [409, 404, 400, 401, 403],
            empty: false,
          },
          requestOptions,
        ).then((value) => value.data),
        ...
        request<SessionWaitOutput>(
          {
            ...
            successStatus: 204,
            declaredStatuses: [404, 503, 400, 401, 403],
            empty: true,
          },
          requestOptions,
        ),
          ...
          request<{ readonly data: SessionRevertStageOutput }>(
            {
              ...
              successStatus: 200,
              declaredStatuses: [404, 409, 500, 400, 401, 403],
              empty: false,
            },
            requestOptions,
          ).then((value) => value.data),
          ...
          request<SessionRevertCommitOutput>(
            {
              ...
              successStatus: 204,
              declaredStatuses: [404, 409, 400, 401, 403],
              empty: true,
            },
            requestOptions,
          ),
        ...
        request<{ readonly data: SessionContextOutput }>(
          {
            ...
            successStatus: 200,
            declaredStatuses: [404, 500, 400, 401, 403],
            empty: false,
          },
          requestOptions,
        ).then((value) => value.data),
            ...
            request<SessionInstructionsEntryPutOutput>(
              {
                ...
                successStatus: 204,
                declaredStatuses: [404, 413, 400, 401, 403],
                empty: true,
              },
              requestOptions,
            ),
        ...
        request<MessageListOutput>(
          {
            ...
            successStatus: 200,
            declaredStatuses: [400, 404, 500, 401, 403],
            empty: false,
          },
          requestOptions,
        ),
        ...
        request<ModelListOutput>(
          {
            ...
            query: { location: input?.["location"] },
            successStatus: 200,
            declaredStatuses: [503, 401, 403, 400],
            empty: false,
          },
          requestOptions,
        ),
        ...
        request<{ readonly data: GenerateTextOutput }>(
          {
            ...
            successStatus: 200,
            declaredStatuses: [400, 503, 401, 403],
            empty: false,
          },
          requestOptions,
        ).then((value) => value.data),
        ...
        request<ProviderGetOutput>(
          {
            ...
            query: { location: input["location"] },
            successStatus: 200,
            declaredStatuses: [404, 503, 401, 403, 400],
            empty: false,
          },
          requestOptions,
        ),
    ...
    project: {
      list: (requestOptions?: RequestOptions) =>
        request<ProjectListOutput>(
          { method: "GET", path: `/api/project`, successStatus: 200, declaredStatuses: [401, 403, 400], empty: false },
          requestOptions,
        ),
    ...
    event: {
      subscribe: (requestOptions?: RequestOptions): AsyncIterable<EventSubscribeOutput> =>
        sse<EventSubscribeOutput>(
          { method: "GET", path: `/api/event`, successStatus: 200, declaredStatuses: [401, 403, 400], empty: false },
          requestOptions,
        ),
    },
    pty: {
        ...
        request<PtyGetOutput>(
          {
            ...
            query: { location: input["location"] },
            successStatus: 200,
            declaredStatuses: [404, 401, 403, 400],
            empty: false,
          },
          requestOptions,
        ),
