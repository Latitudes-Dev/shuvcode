...
export type AuthStatusOutput = { readonly location: Location.Info; readonly data: Auth.Status }
export type AuthStatusOperation<E = never> = (input?: AuthStatusInput) => Effect.Effect<AuthStatusOutput, E>
